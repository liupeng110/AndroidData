...
public class OkHttp3Utils {
    ...
    //设置缓存目录
    private static File cacheDirectory = new File(App.getContext().getCacheDir().getAbsolutePath(), "MyCache");
    ...
    private static class MyIntercepter implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (!isNetworkReachable(App.getContext())) {
                Toast.makeText(App.getContext(), "暂无网络", Toast.LENGTH_SHORT).show();
